...
urlpatterns = [
    ...
    path('password-reset/done/', PasswordResetDoneView.as_view(template_name = "SportsGrounds/password_reset_done.html"),
         name='password_reset_done'),
    path('password-reset/<uidb64>/<token>/', views.UserPasswordResetConfirmView.as_view(), name='password_reset_confirm'),
    path('password-reset/complete/', PasswordResetCompleteView.as_view(
        template_name="SportsGrounds/password_reset_complete.html"), name='password_reset_complete'),
    ]
